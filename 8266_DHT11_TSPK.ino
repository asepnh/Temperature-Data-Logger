...
const int sensorDHT1 = 5; //D1
const int sensorDHT2 = 4; //D2
const int sensorDHT3 = 14; //D5
const int sensorDHT4 = 12; //D6
...
// Tetapan Thingspeak
char * ssid = "R. Rapat Terbatas";   // your network SSID (name) 
