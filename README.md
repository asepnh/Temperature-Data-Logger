...
- https://microbit.org/projects/make-it-code-it/makecode-wireless-data-logger/  
  No limit to the recording time, file is stored as csv in laptop, can use a remote microbit, uses makecode block programming. But no indication on the timing. 
